  ...
  return (
    <div className="md:flex h-screen transition-all">
      <div className="md:w-[50%] flex justify-center items-center px-5 h-screen w-full">
        <div>
          <XLText className="text-center leading-8">Welcome To</XLText>
          <FurniFlexSVG className="mt-4 mx-auto mb-2" />
          <Text className="text-[#707070] text-center mb-5">
              ...
              <Form className="flex flex-col gap-4 mb-3">
                <div className="flex sm:flex-nowrap flex-wrap gap-4">
                  <div className="w-full border border-[#D9D9D9] px-[11px] py-[8px] rounded-[6px]">
                    <SText className="text-[#707070]">First Name ( optional )</SText>
                    <Field
                      type="email"
                      name="email"
                  ...
                  <div className="w-full border border-[#D9D9D9] px-[11px] py-[8px] rounded-[6px]">
                    <SText className="text-[#707070]">Last Name ( optional )</SText>
                    <Field
                      type="email"
                      name="email"
